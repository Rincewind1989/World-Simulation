...
extern const int INFORMATION_TEXT_SIZE;
extern const double RADIUS_NEURON;	//Radius of a drawn neuron on the information window
extern const double DISTANCE_Y_NEURON_FACTOR;
extern const double DISTANCE_INPUT_NEURON_FACTOR;
extern const double DISTANCE_HIDDEN_NEURON_FACTOR;
extern const double DISTANCE_OUTPUT_NEURON_FACTOR;
//----------------------------------------------------------------------
//Life properties
//Organism properties
...
extern const double MUTATE_STAT;				//Chance that a color mutates
extern const double MOVEMENT_ENERGY_FACTOR_IN_WATER;	//Factor for movement penalty in water
extern const double MOVEMENT_REDUCTION_IN_WATER;
extern const double TIME_FOR_FITNESS_REPRODUCTION;
//----------------------------------------------------------------------
//Network properties
